...
--
-- Host: localhost
-- Generation Time: Mar 11, 2017 at 01:39 PM
...
(6, 2, 'Jojo''s Bizzare Adventure Part 3: Stardust Crusaders', 'Manga', 'Jotaro Kujo', 'Good', 1, 'Trading', 43.52, '2017-03-06 19:52:47', 'Active'),
(7, 1, 'Highway 61 Revisited', 'Album', '', 'Acceptable', 0, 'Trading', 600.65, '2017-03-06 22:14:50', 'Active');
...
('4oZPYNtk2ZyYDHUBz3aojKfNDIs54E9r', 1489290446, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"loginUser":"bob","loginUserId":1}');
...
INSERT INTO `trades` (`trade_id`, `item_id`, `user_id`, `tradeQuantity`, `tradeStatus`, `priceOffer`, `tradeDesc`, `dateSent`) VALUES
(2, 7, 2, 1, 'Completed', 600.65, 'I want to add this to a new album collection.', '2017-03-10 00:00:00');

--
-- Triggers `trades`
--
DELIMITER $$
CREATE TRIGGER `tradeDateSent` BEFORE INSERT ON `trades` FOR EACH ROW SET NEW.dateSent = NOW()
$$
DELIMITER ;
...
CREATE TABLE `tradingStatus` (
  `trade_id` int(11) NOT NULL,
  `ownerStatus` enum('Not Received','Received','Canceled') NOT NULL,
  `traderStatus` enum('Not Received','Received','Canceled') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tradingStatus`
--

INSERT INTO `tradingStatus` (`trade_id`, `ownerStatus`, `traderStatus`) VALUES
(2, 'Received', 'Received');
